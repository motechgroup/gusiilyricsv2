...
<head>
    ...
    @php
        ...
        $footerDescription = \App\Models\Setting::get('footer_description', 'Preserving Gusii music heritage, song lyrics, translations, and official streaming links for Omogusii worldwide.');
    @endphp
    ...
    <header class="glass-nav sticky top-0 z-40 px-4 sm:px-6 lg:px-8 py-3.5 border-b border-gray-800/80">
        ...
        <div id="headerSearchModal" class="hidden pt-4 pb-2 border-t border-gray-800/80 mt-3 max-w-4xl mx-auto px-2">
            <form method="GET" action="{{ route('songs.index') }}" class="relative flex items-center">
                ...
                <input type="text" name="q" placeholder="Type song title, artist name, or word (e.g. Babu Gee, Nore Pipo)..." class="w-full pl-12 pr-28 py-3 bg-gray-950 border border-amber-400/50 rounded-2xl text-white placeholder-gray-400 text-sm focus:outline-none focus:border-emerald-400 shadow-2xl">
