            ...
            <nav class="space-y-1">
                ...
                @if(Auth::user() && Auth::user()->isAdmin())
                    <div class="pt-4 border-t border-gray-800/80 space-y-1">
                        ...
                        <a href="{{ route('admin.seo.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold transition {{ request()->routeIs('admin.seo.*') ? 'bg-emerald-500 text-slate-950 shadow-md font-bold' : 'text-gray-300 hover:bg-gray-800/60 hover:text-white' }}">
                            ...
                            <span>SEO Intelligence Engine</span>
                        </a>
                        ...
                        <a href="{{ route('admin.mail-templates.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold transition {{ request()->routeIs('admin.mail-templates.*') ? 'bg-emerald-500 text-slate-950 shadow-md font-bold' : 'text-gray-300 hover:bg-gray-800/60 hover:text-white' }}">
                        ...
                        <!-- System Version & Docs -->
                        <a href="{{ route('admin.docs.index') }}" class="flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-semibold transition {{ request()->routeIs('admin.docs.*') ? 'bg-emerald-500 text-slate-950 shadow-md font-bold' : 'text-gray-300 hover:bg-gray-800/60 hover:text-white' }}">
                            <div class="flex items-center gap-3">
                                <svg class="w-4 h-4 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                                <span>System & Docs</span>
                            </div>
                            <span class="px-1.5 py-0.5 rounded bg-emerald-500/20 text-emerald-300 text-[9px] font-mono font-bold border border-emerald-500/30">v2.4.0</span>
                        </a>
                    </div>
                @endif
            </nav>
