    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div class="flex flex-col md:flex-row items-center md:items-end gap-6 sm:gap-8 text-center md:text-left">
            ...
            <div class="space-y-3 flex-grow">
                ...
                @if($artist->youtube || $artist->facebook || $artist->instagram || $artist->spotify || $artist->tiktok || $artist->website)
                    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 pt-2">
                        @if($artist->youtube)
                            <a href="{{ $artist->youtube }}" target="_blank" rel="noopener" class="px-3.5 py-1.5 rounded-xl bg-rose-500/15 hover:bg-rose-500/25 text-rose-400 border border-rose-500/30 text-xs font-bold transition flex items-center gap-1.5">
                        ...
                        @if($artist->facebook)
                            <a href="{{ $artist->facebook }}" target="_blank" rel="noopener" class="px-3.5 py-1.5 rounded-xl bg-sky-500/15 hover:bg-sky-500/25 text-sky-400 border border-sky-500/30 text-xs font-bold transition flex items-center gap-1.5">
                        ...
                        @if($artist->instagram)
                            <a href="{{ $artist->instagram }}" target="_blank" rel="noopener" class="px-3.5 py-1.5 rounded-xl bg-pink-500/15 hover:bg-pink-500/25 text-pink-400 border border-pink-500/30 text-xs font-bold transition flex items-center gap-1.5">
                        ...
                        @if($artist->spotify)
                            <a href="{{ $artist->spotify }}" target="_blank" rel="noopener" class="px-3.5 py-1.5 rounded-xl bg-emerald-500/15 hover:bg-emerald-500/25 text-[#1DB954] border border-[#1DB954]/30 text-xs font-bold transition flex items-center gap-1.5">
                        ...
                        @if($artist->tiktok)
                            <a href="{{ $artist->tiktok }}" target="_blank" rel="noopener" class="px-3.5 py-1.5 rounded-xl bg-cyan-500/15 hover:bg-cyan-500/25 text-cyan-400 border border-cyan-500/30 text-xs font-bold transition flex items-center gap-1.5">
                        ...
                        @if($artist->website)
                            <a href="{{ $artist->website }}" target="_blank" rel="noopener" class="px-3.5 py-1.5 rounded-xl bg-gray-800 hover:bg-gray-700 text-gray-300 border border-gray-700 text-xs font-bold transition flex items-center gap-1.5">
