...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-14">
    ...
    @php
        $statWeb = \App\Models\Setting::get('social_stat_web_traffic', '150,000+');
        $labelWeb = \App\Models\Setting::get('social_stat_web_label', 'Monthly Web Traffic');
        $countWeb = preg_replace('/[^0-9]/', '', $statWeb) ?: '150000';

        $statYt = \App\Models\Setting::get('social_stat_youtube_subscribers', '25,000+');
        $labelYt = \App\Models\Setting::get('social_stat_youtube_label', 'YouTube Subscribers');
        $countYt = preg_replace('/[^0-9]/', '', $statYt) ?: '25000';

        $statIg = \App\Models\Setting::get('social_stat_instagram_followers', '18,500+');
        $labelIg = \App\Models\Setting::get('social_stat_instagram_label', 'Instagram Followers');
        $countIg = preg_replace('/[^0-9]/', '', $statIg) ?: '18500';

        $statTk = \App\Models\Setting::get('social_stat_tiktok_community', '32,000+');
        $labelTk = \App\Models\Setting::get('social_stat_tiktok_label', 'TikTok Community');
        $countTk = preg_replace('/[^0-9]/', '', $statTk) ?: '32000';
    @endphp
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div onmouseenter="triggerCardCounter(this)" class="p-6 rounded-3xl bg-gray-950/80 hover:bg-gray-900 border border-emerald-500/30 hover:border-amber-400/60 text-center space-y-3 transition-all duration-300 transform hover:-translate-y-2 hover:scale-[1.02] shadow-xl hover:shadow-2xl hover:shadow-emerald-500/10 cursor-pointer group">
            ...
            <div class="text-2xl sm:text-4xl font-black text-emerald-400 group-hover:text-amber-300 font-mono transition-colors counter-element" data-count="{{ $countWeb }}" data-suffix="+">
                {{ $statWeb }}
            </div>
            <p class="text-[11px] text-gray-400 group-hover:text-white font-bold uppercase tracking-wider transition">{{ $labelWeb }}</p>
        </div>
        ...
        <div onmouseenter="triggerCardCounter(this)" class="p-6 rounded-3xl bg-gray-950/80 hover:bg-gray-900 border border-rose-500/30 hover:border-amber-400/60 text-center space-y-3 transition-all duration-300 transform hover:-translate-y-2 hover:scale-[1.02] shadow-xl hover:shadow-2xl hover:shadow-rose-500/10 cursor-pointer group">
            ...
            <div class="text-2xl sm:text-4xl font-black text-rose-400 group-hover:text-amber-300 font-mono transition-colors counter-element" data-count="{{ $countYt }}" data-suffix="+">
                {{ $statYt }}
            </div>
            <p class="text-[11px] text-gray-400 group-hover:text-white font-bold uppercase tracking-wider transition">{{ $labelYt }}</p>
        </div>
        ...
        <div onmouseenter="triggerCardCounter(this)" class="p-6 rounded-3xl bg-gray-950/80 hover:bg-gray-900 border border-pink-500/30 hover:border-amber-400/60 text-center space-y-3 transition-all duration-300 transform hover:-translate-y-2 hover:scale-[1.02] shadow-xl hover:shadow-2xl hover:shadow-pink-500/10 cursor-pointer group">
            ...
            <div class="text-2xl sm:text-4xl font-black text-pink-400 group-hover:text-amber-300 font-mono transition-colors counter-element" data-count="{{ $countIg }}" data-suffix="+">
                {{ $statIg }}
            </div>
            <p class="text-[11px] text-gray-400 group-hover:text-white font-bold uppercase tracking-wider transition">{{ $labelIg }}</p>
        </div>
        ...
        <div onmouseenter="triggerCardCounter(this)" class="p-6 rounded-3xl bg-gray-950/80 hover:bg-gray-900 border border-cyan-500/30 hover:border-amber-400/60 text-center space-y-3 transition-all duration-300 transform hover:-translate-y-2 hover:scale-[1.02] shadow-xl hover:shadow-2xl hover:shadow-cyan-500/10 cursor-pointer group">
            ...
            <div class="text-2xl sm:text-4xl font-black text-cyan-400 group-hover:text-amber-300 font-mono transition-colors counter-element" data-count="{{ $countTk }}" data-suffix="+">
                {{ $statTk }}
            </div>
            <p class="text-[11px] text-gray-400 group-hover:text-white font-bold uppercase tracking-wider transition">{{ $labelTk }}</p>
        </div>
    </div>
