        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-xs text-gray-300">
                <thead class="bg-gray-950 text-gray-400 uppercase tracking-wider text-[10px] border-b border-gray-800">
                    <tr>
                        <th class="p-4">Advertiser & Company</th>
                        <th class="p-4">Contact Info</th>
                        <th class="p-4">Placement Spot</th>
                        <th class="p-4">Duration/Budget</th>
                        <th class="p-4">Artwork</th>
                    ...
                    @forelse($inquiries as $inq)
                        ...
                        @if($inq->message)
                            <tr class="bg-gray-950/40">
                                <td colspan="7" class="p-3 text-[11px] text-gray-400 italic font-sans border-b border-gray-800/80">
                                    💬 Message: "{{ $inq->message }}"
                                </td>
                            </tr>
                        @endif
